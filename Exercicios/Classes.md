...
9. Crie uma classe `ContaBancaria` com os atributos `titular`, `saldo` e `numero_conta`. Adicione métodos para depositar, levantar e exibir saldo. O titular deve ser uma classe, que pode ter várias contás bancárias. Teste criando algumas contas e realize operações para essa várias contas.